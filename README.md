...
### Fullstack Developer (Freelance) | 9/2024 – Present

_Domains: Digital Marketing Automation, Content Creation, SaaS Platforms_

- **Architected and developed** high-impact applications for digital marketing and content automation, serving clients globally with scalable SaaS solutions.
- **Built** **nexo-studio**, an AI-powered video creation platform using **Electron JS, React, TypeScript, and Node.js** with intelligent content generation workflows, real-time preview system, and batch processing capabilities. Successfully processed 50,000+ videos with 99.2% uptime.
- **Developed** **navigo**, a browser automation and profile management platform using **React, Tailwind CSS, Node.js, Flask (Python), and PostgreSQL**. Implemented advanced fingerprint management, multi-account dashboard supporting 10,000+ profiles, and real-time automation monitoring with WebSocket connections.
- **Established** comprehensive CI/CD pipelines, Monorepo architecture with TurboRepo, and achieved 95+ Lighthouse scores across all projects with 95%+ TypeScript coverage.
- **Key Tech Stack:** React, Vue 3, TypeScript, Electron JS, Node.js, Flask, PostgreSQL, Redis, Docker, AWS, TurboRepo, Storybook.
